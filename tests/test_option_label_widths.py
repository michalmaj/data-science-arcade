...
from data_science_arcade.lessons.l19_power_plant.scenario import (
    COLD_DURATION_PICK_FIELD as L19_COLD_DURATION_PICK_FIELD,
    DECISION_FIELDS as L19_DECISION_FIELDS,
    MASTERY_DESIGN_JUDGMENT_FIELD as L19_MASTERY_DESIGN_JUDGMENT_FIELD,
    MASTERY_EVIDENCE_FIELD as L19_MASTERY_EVIDENCE_FIELD,
    MASTERY_RESULT_INTERPRETATION_FIELD as L19_MASTERY_RESULT_INTERPRETATION_FIELD,
    POWER_REVEAL_INTERPRET_OPTIONS as L19_POWER_REVEAL_INTERPRET_OPTIONS,
...
def _collect_checks() -> list[tuple[str, str, int]]:
    ...
    brief_fields = (
        ...
        *L18_DECISION_FIELDS,
        ...
        L19_COLD_DURATION_PICK_FIELD,
        *L19_DECISION_FIELDS,
        L19_MASTERY_DESIGN_JUDGMENT_FIELD,
