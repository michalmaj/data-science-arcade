...
from data_science_arcade.lessons.l15_segment_detective.requests import CORRECT_OPTION_BY_REQUEST
...
def _pick_every_slice_correctly(scene: SegmentSlicerScene) -> None:
...
def test_the_full_lesson_plays_through_all_eight_stages_to_a_result():
    ...
    try:
        finished_results = []
        runner, collected = build_lesson_fifteen_runner(
        ...
        _pick_every_slice_correctly(app.scenes.current)
