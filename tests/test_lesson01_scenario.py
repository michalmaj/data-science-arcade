...
def test_the_full_lesson_plays_through_all_eight_stages_to_a_result():
    ...
    try:
        ...
        assert isinstance(app.scenes.current, BriefBuilderScene)
        ...
        assert isinstance(app.scenes.current, TwistRevealScene)
...
def test_next_is_disabled_until_a_choice_is_made_on_each_field():
    ...
    try:
        ...
        assert isinstance(brief_scene, BriefBuilderScene)
