...
def test_finishing_lesson_twenty_one_marks_it_complete_and_unlocks_lesson_twenty_two():
    ...
    try:
        ...
        _play_dialogue_to_the_end(app.scenes.current)  # briefing
        _play_dialogue_to_the_end(app.scenes.current)  # investigation
        _play_dialogue_to_the_end(app.scenes.current)  # instrumentation_explanation

        assert isinstance(app.scenes.current.inner, FunnelBuilderScene)  # initial_funnel_pass
        _pick_every_l21_definition_correctly(app.scenes.current)

        assert isinstance(app.scenes.current.inner, ComparisonRevealScene)  # definition_axis_reveal
        _confirm_reveal(app.scenes.current.inner)
        assert isinstance(app.scenes.current.inner, ComparisonRevealScene)  # basis_axis_reveal
        _confirm_reveal(app.scenes.current.inner)

        _play_dialogue_to_the_end(app.scenes.current)  # revision_intro

        assert isinstance(app.scenes.current.inner, FunnelBuilderScene)  # revision_funnel_pass
        _pick_every_l21_definition_correctly(app.scenes.current)
...
def test_finishing_lesson_twenty_three_marks_it_complete_and_unlocks_lesson_twenty_four():
    ...
    try:
        ...
        _pick_every_l23_option_correctly(app.scenes.current)
...
def test_finishing_lesson_twenty_four_marks_it_complete_and_unlocks_lesson_twenty_five():
    ...
    try:
        ...
        _pick_every_l24_combo_correctly(app.scenes.current)
...
def test_finishing_lesson_twenty_six_marks_it_complete_and_unlocks_lesson_twenty_seven():
    ...
    try:
        ...
        _pick_every_l26_option_correctly(app.scenes.current)
