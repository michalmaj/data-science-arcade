...
def test_the_full_lesson_plays_through_all_eight_stages_to_a_result():
    ...
    try:
        finished_results = []
        runner, collected = build_lesson_twenty_four_runner(
        ...
        assert isinstance(app.scenes.current.inner, SurveyBuilderScene)  # guided
        ...
        assert isinstance(app.scenes.current.inner, SurveyBuilderScene)  # independent
