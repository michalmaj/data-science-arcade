...
# Public (not module-private) - reused directly as fixed reference
# definitions by the two mandatory synthesis reveals in scenario.py,
# never rebuilt or re-derived there.
LEGACY_CART_TRACKING = build_funnel_definition(
    CHECKOUT_EVENTS,
...
COMPLETE_CART_TRACKING = build_funnel_definition(
    CHECKOUT_EVENTS,
    "complete_cart_tracking",
    "complete_cart_tracking",
    "lesson.l21.definition.complete_cart_tracking",
)
PERCENT_OF_TOTAL_VISITS = build_funnel_definition(
    CHECKOUT_EVENTS,
    "complete_cart_tracking",
...
PERCENT_OF_PREVIOUS_STEP = build_funnel_definition(
    CHECKOUT_EVENTS,
    "complete_cart_tracking",
...
RAW_CART_EVENTS = build_funnel_definition(
    CHECKOUT_EVENTS,
    "raw_cart_events",
    "raw_cart_events",
...
UNIQUE_SESSION_CART = build_funnel_definition(
    CHECKOUT_EVENTS,
    "complete_cart_tracking",
    "unique_session_cart",
...
MOBILE_DROPOUT_COMPLAINT = FunnelRequest(
    ...
    definitions=(LEGACY_CART_TRACKING, COMPLETE_CART_TRACKING),
)
PAYMENT_STEP_COMPLAINT = FunnelRequest(
    ...
    definitions=(PERCENT_OF_PREVIOUS_STEP, PERCENT_OF_TOTAL_VISITS),
)
CART_ABANDONMENT_COMPLAINT = FunnelRequest(
    ...
    definitions=(RAW_CART_EVENTS, UNIQUE_SESSION_CART),
)
